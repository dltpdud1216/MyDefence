...
namespace Sample
{
    public class ComponentTest : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //[2] 이동 목표 지점
            //targetPosition = new Vector3(7f, 1f, 8f); >> 1(좌표를 직접 지정해줘야함)
            //targetPosition = targetGameObject.transform.position; >> 2
            //targetPosition = targetTransform.position; >> 3 **2,3 모두 같은 뜻

            //TargetTest 클래스의 인스턴스 생성 - 문법
            //MonoBehaviour를 상속받는 클래스는 new로 인스턴스 생성해서 사용하지 않는다
            ...
            //TargetTest 클래스가 붙어있는 게임 오브젝트에서 직접 TargetTest클래스 인스턴스 접근
            cTest.a = 90;
